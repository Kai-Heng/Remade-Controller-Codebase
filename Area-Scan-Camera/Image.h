...
/// <summary>
/// Splits an image into multiple images
/// </summary>
class ImageSplitter
{
public:
    /// <summary>
    /// Creates a new image splitter with the image to be splitted
    /// </summary>
    /// <param name="i">image to be splitted</param>
    ImageSplitter(Image i) : image(i){}

    /// <summary>
    /// Splits the image into smaller images
    /// </summary>
    /// <param name="numImagesX">Number of images splitted on the X axis</param>
    /// <param name="numImagesY">Number of images splitted on the Y axis</param>
    /// <returns></returns>
    vector<Image> getSplittedImages(const size_t numImagesX, const size_t numImagesY);

    /// <summary>
    /// Cleans up the image splitter
    /// <summary>
    ~ImageSplitter(void)
    {
        image.releaseBuffer();
